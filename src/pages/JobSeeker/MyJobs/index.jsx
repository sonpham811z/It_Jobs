...
const appliedJobs = [
    {
      id: 1,
      logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTdtMA3E5OCHKJMv9p19P_BF_7hjxyMy1jhZg&s', // Placeholder cho logo công ty
      title: 'Fresher Python Developer',
      company: 'Tech Corp',
      city: 'Ho Chi Minh',
      workType: 'At office',
      status: 'Accepted', // Trạng thái: Accepted, Pending, Expired
    },
    {
      id: 2,
    ...
    <Box sx={{ p: 2, mt: 3, borderRadius: 1,          boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1)', // Bóng nhẹ
      ...
      >
        <Tab
          label={
            <Badge
              badgeContent={appliedJobs.length}
              sx={{
                '& .MuiBadge-badge': {
